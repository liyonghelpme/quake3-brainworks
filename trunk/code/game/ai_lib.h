...
int bsearch_addr(const void *key, const void *list, size_t list_size, size_t entry_size, cmp_t *compare, void **match);
#if defined ( Q3_VM )
void *bsearch(const void *match, const void *list, size_t list_size, size_t entry_size, cmp_t *compare);
#endif
void *bsearch_ins(const void *key, void *list, size_t *list_size, size_t max_list_size, size_t entry_size, cmp_t *compare, int *insert);
...
octree_node_t *octree_assemble(octree_node_t *nodes, int num_nodes,
							   const float *(data_origin)(const void *));
